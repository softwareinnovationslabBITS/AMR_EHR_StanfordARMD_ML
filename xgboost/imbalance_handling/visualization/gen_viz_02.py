# Source: /AMR_Stanford/py_codes/xg_classw/gen_viz_02.py
"""
gen_viz_02.py
--------------
Generates the full visualization suite for the 02_class_weights model.
Run 02_class_weights.py first.

Outputs everything to ./visualizations/02_class_weights/
"""
