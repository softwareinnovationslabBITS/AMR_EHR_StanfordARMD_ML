# Source: /AMR_Stanford/py_codes/xg_classw/gen_viz_06.py
"""
gen_viz_06.py
--------------
Generates the full visualization suite for the 06_kfold_cv model — this is
the FINAL model retrained on the full training set after CV (not any
single fold's model), same one 06_kfold_cv.py saved to disk.
Run 06_kfold_cv.py first.

Outputs everything to ./visualizations/06_kfold_cv/
"""
