# Source: /AMR_Stanford/py_codes/xg_classw/gen_viz_04.py
"""
gen_viz_04.py
--------------
Generates the full visualization suite for the 04_undersampling model.
Run 04_undersampling.py first.

Outputs everything to ./visualizations/04_undersampling/
"""
